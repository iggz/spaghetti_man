...
while running:
    ...
    for event in pygame.event.get():
        # Check for KEYDOWN event; KeDOWN is a constant defined in pygame.locals, which is imported at the top
    ...
    # This is the COLLISION event. Kills player if player and enemy collide.
